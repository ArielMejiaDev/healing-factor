...
it('prunes stale resolved issues', function () {
    ...
    $this->artisan('healing-factor:prune --days=30')
        ->assertExitCode(0);
...
it('does not prune pending issues', function () {
    ...
    $this->artisan('healing-factor:prune --days=1')
        ->assertExitCode(0);
